...
TestMediaPlayerOptions::TestMediaPlayerOptions()
    ...
    , iOptionTidal("", "--tidal", Brn(""), "TIDAL details - partner_id:client_id:client_secret:app_id:app_client_id:app_client_secret **NOTE** Multiple apps can be specified here")
