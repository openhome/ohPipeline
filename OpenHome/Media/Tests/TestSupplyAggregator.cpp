...
void SuiteSupplyAggregator::OutputNextNonAudioMsg()
{
    ...
    case EMsgEncodedStream:
        ...
        break;
    case EMsgStreamSegment:
        iSupply->OutputSegment(Brn(kSegmentId));
        break;
    case EMsgMetaText:
...
Msg* SuiteSupplyAggregator::ProcessMsg(MsgStreamSegment* aMsg)
{
...
Msg* SuiteSupplyAggregator::ProcessMsg(MsgAudioDsd* aMsg)
{
    ASSERTS(); // don't expect this type of msg at the start of the pipeline
    return aMsg;
}
