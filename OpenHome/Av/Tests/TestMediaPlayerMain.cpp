...
void TestMediaPlayerThread::RunInThread()
{
    ...
    Media::AnimatorBasic* animator = new Media::AnimatorBasic(dvStack->Env(), tmp->Pipeline(), iOptions.ClockPull().Value(), tmp->DsdSampleBlockWords(), tmp->DsdPadBytesPerChunk());
