...
def configure(conf):
    ...
    if conf.options.dest_platform in ['armhf-kirkstone-linux', 'armhf-scarthgap-linux', 'aarch64-kirkstone-linux', 'aarch64-scarthgap-linux']:
    ...
    if conf.options.dest_platform in ['Mac-x64', 'Mac-arm64', 'armhf-scarthgap-linux']:
    ...
    elif conf.options.dest_platform in ['armhf-buildroot-linux', 'armhf-kirkstone-linux', 'armhf-scarthgap-linux', 'armhf-raspbian-linux', 'aarch64-kirkstone-linux', 'aarch64-scarthgap-linux']:
    ...
    elif conf.options.dest_platform in ['armhf-buildroot-linux', 'armhf-kirkstone-linux', 'armhf-scarthgap-linux', 'armhf-raspbian-linux']:
...
def build(bld):
    ...
    main = bld.stlib(
            source=[
                ...
                'OpenHome/Media/Pipeline/Brancher.cpp',
    ...
    bld.stlib(
            source=[
                ...
                'OpenHome/Av/Songcast/EnableProcessor.cpp',
    ...
    bld.stlib(
            source=[
                ...
                'OpenHome/Media/Tests/TestSenderQueue.cpp',
