    ...
    case eMdataNone:
        {
            ...
            // For 'Complete' streams, this will only be called into when the single 'mdat' box is processed.
            // However, 'Fragmented' streams are comprised of multiple 'mdat' boxes and so this will be called for each 'mdat' box we visit.
            // Codec info is generated by the boxes at the start of the stream and so later 'mdat' boxes do not provide this.
            // Therefore, it's safe to ignore this. If this is the first 'mdat' box and no codecInfo is provided then it's unlikely we'll play
            // anyway as the encoded audio will not be recognised.
            if (iContainerInfo.ProcessingMode() == Mpeg4ContainerInfo::EProcessingMode::Fragmented && codecInfo == nullptr) {
